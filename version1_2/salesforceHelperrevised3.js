	...
	function createInfoBar(){
		...
		if(document.getElementById(milestoneBodyID).children[0].children[0].children[0].children[0].innerHTML !== "No records to display"){
            ...
            for (var i = 0,len=children.length; i < len; i++) {
                ...
                if (milestoneArray[i].children[1].innerText == "TTFR") {
                    console.log('TTFR if hit');
                    milestoneTTFR = milestoneArray[i].children[3].innerHTML;
                }
                if (milestoneArray[i].children[1].innerText == "TTCR") {
                    console.log('TTCR if hit');
                    milestoneTTCR = milestoneArray[i].children[3].innerHTML;
                }
                if (milestoneArray[i].children[1].innerText == "TTSR") {
                    console.log('TTSR if hit');
                    milestoneTTSR = milestoneArray[i].children[3].innerHTML;
                }
            }
		...
		$('#infoBar').append("<div class='infoBarLeft'> <span class='slaStatus'>"+"Status: "+slaStatus+"<br>"+TTCRInfo+"</span><br>Version 1.3</div>");
